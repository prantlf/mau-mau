...
var SmartComputer = function (_Computer) {
  ...
  function SmartComputer() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(SmartComputer).apply(this, arguments));
  }
...
function suggestSuit(chosenCard, availableCards) {
  ...
  var nextChosenCardsPerSuit = Object.keys(_Suits2.default).map(function (suit) {
  ...
  var _filterMaximumCovers = filterMaximumCovers(nextChosenCardsPerSuit);

  var // Identify cards, which allow us to shed the most cards
  maximumCovers = _filterMaximumCovers.maximumCovers;
  var maximumCover = _filterMaximumCovers.maximumCover;
  var nextChosenCards = maximumCovers.map(function (cardCover) {
  ...
  var nextChosenCard = nextChosenCards.find(function (card) {
...
function pickMaximumCover(covers) {
  ...
  var maximumCovers = _filterMaximumCovers2.maximumCovers;
  var maximumCover = _filterMaximumCovers2.maximumCover;
